...
public class TripData {
    ...
    public TripData(String title, int id, CreatorData creator, String description, LocationData location, BitmapData mainImage, ActivityData[] activities, Float reviewsAverage, List<Integer> reviews) {
        this.title = title;
        this.id = id;
